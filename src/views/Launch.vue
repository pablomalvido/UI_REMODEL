...
export default {
  ...
  data(){
    return{
      ...
      launchers: {
        1: {name: 'Robot', launch_files:[{pkg: 'robot_ws/src/motoman/motoman_sda10f_moveit_config', file: 'moveit_planning_execution_no_gripper'}], active: 'gray', nodes:['/io_relay','/joint_state','/joint_trajectory_action','/move_group','/motion_streaming_interface','/robot_state_publisher'], roles:['Administrator', 'Operator']},
        2: {name: 'Grippers', launch_files:[{pkg: 'robot_ws/src/wsg50-ros-pkg-remodel-melodic-devel/wsg_50_driver', file: 'left_wsg_50_tcp_actions'}], active: 'gray', nodes:['/gripper_action_server_left', '/left_wsg/wsg_50_driver'], roles:['Administrator', 'Operator']},
        3: {name: 'Robot demo', launch_files:[{pkg: 'robot_ws/src/motoman/motoman_sda10f_moveit_config', file: 'demo_no_gripper_camera'}], active: 'gray', nodes:['/joint_state_publisher','/move_group','/robot_state_publisher'], roles:['Administrator', 'Operator']},
        4: {name: 'CAD Platform', launch_files:[{pkg: 'remodel_demos_ws/src/elvez_pkg', file: 'launcher'}], active: 'gray', nodes:['/ATC_rf','/UC2_handler','/combs_rf','/platform_rf'], roles:['Administrator', 'Operator']}, 
        ...
        11: {name: 'CAD files update', launch_files:[{pkg: 'remodel_demos_ws/src/elvez_pkg', file: 'update_files'}], active: 'gray', nodes:['/CAD_loader'], roles:['Administrator']},                
