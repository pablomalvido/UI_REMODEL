  ...
  data(){
    return{
      ...
      launchers: {
        ...
        14: {name: 'Configuration', launch_files:[{pkg: 'UI_nodes_pkg', file: 'config'}], active: 'gray', nodes:['/config_node'], roles:['Administrator']},  
        12: {name: 'Force sensor (R)', launch_files:[{pkg: 'norbdo_force_sensor', file: 'right_norbdo'}], active: 'gray', nodes:['/right_norbdo/norbdo_fs'], roles:['Administrator','Operator']},      
        13: {name: 'Fake sensors', launch_files:[{pkg: 'UI_nodes_pkg', file: 'fake_sensors'}], active: 'gray', nodes:['/fake_sensors'], roles:['Administrator']},
        17: {name: 'Record trajectory', launch_files:[{pkg: 'UI_nodes_pkg', file: 'record_traj'}], active: 'gray', nodes:['/record_traj'], roles:['Administrator']},
        16: {name: 'Safety manager', launch_files:[{pkg: 'remodel_safety_manager', file: 'RSM'}], active: 'gray', nodes:['/RSM_PLC_connection'], roles:['Administrator', 'Operator']},
        15: {name: 'CAD files update', launch_files:[{pkg: 'elvez_pkg', file: 'update_files'}], active: 'gray', nodes:['/CAD_loader'], roles:['Administrator']},                
