...
export default {
  ...
  data(){
    return{
      ...
      launchers: {
        1: {name: 'Robot', launch_files:[{pkg: 'robot_ws/motoman/motoman_sda10f_moveit_config', file: 'moveit_planning_execution_no_gripper'}], active: 'gray', nodes:['/io_relay','/joint_state','/joint_trajectory_action','/move_group','/motion_streaming_interface','/robot_state_publisher'], roles:['Administrator', 'Operator']},
        2: {name: 'Grippers', launch_files:[{pkg: 'robot_ws/wsg50-ros-pkg-remodel-melodic-devel/wsg_50_driver', file: 'left_wsg_50_tcp_actions'}], active: 'gray', nodes:['/gripper_action_server_left', '/left_wsg/wsg_50_driver'], roles:['Administrator', 'Operator']},
        3: {name: 'Robot demo', launch_files:[{pkg: 'robot_ws/motoman/motoman_sda10f_moveit_config', file: 'demo_no_gripper_camera'}], active: 'gray', nodes:['/joint_state_publisher','/move_group','/robot_state_publisher'], roles:['Administrator', 'Operator']},
        4: {name: 'CAD Platform', launch_files:[{pkg: 'remodel_demos_ws/src/CAD_Platform_Interface', file: 'launcher'}], active: 'gray', nodes:['/ATC_rf','/UC2_handler','/combs_rf','/platform_rf'], roles:['Administrator', 'Operator']}, 
        5: {name: 'Process control', launch_files:[{pkg: 'remodel_demos_ws/src/UI_nodes_pkg', file: 'process'}], active: 'gray', nodes:['/elvez_process_action_server','/process_action_client','/process_feedback'], roles:['Administrator', 'Operator']},
        6: {name: 'Manual control', launch_files:[{pkg: 'remodel_demos_ws/src/UI_nodes_pkg', file: 'moveit_manual'}], active: 'gray', nodes:['/moveit_manual'], roles:['Administrator']},
        7: {name: 'Configuration', launch_files:[{pkg: 'remodel_demos_ws/src/UI_nodes_pkg', file: 'config'}], active: 'gray', nodes:['/config_node'], roles:['Administrator']},        
        8: {name: 'Fake sensors', launch_files:[{pkg: 'remodel_demos_ws/src/UI_nodes_pkg', file: 'fake_sensors'}], active: 'gray', nodes:['/fake_sensors'], roles:['Administrator']},
        9: {name: 'Record trajectory', launch_files:[{pkg: 'remodel_demos_ws/src/UI_nodes_pkg', file: 'record_traj'}], active: 'gray', nodes:['/record_traj'], roles:['Administrator']},
        10: {name: 'Safety manager', launch_files:[{pkg: 'remodel_demos_ws/src/remodel_safety_manager', file: 'RSM'}], active: 'gray', nodes:['/RSM_PLC_connection'], roles:['Administrator', 'Operator']},
        11: {name: 'CAD files update', launch_files:[{pkg: 'remodel_demos_ws/src/CAD_Platform_Interface', file: 'update_files'}], active: 'gray', nodes:['/CAD_loader'], roles:['Administrator']},                
